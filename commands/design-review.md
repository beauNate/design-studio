...
Read `references/ux-researcher.md` — focus on the WCAG AA Checklist section.
...
Read `references/ux-researcher.md` — apply Nielsen's 10 heuristics.
...
Read `references/design-system-lead.md` — use the Consistency Review Checklist.
...
### 4. Content Review
Read `references/content-designer.md` — use the Content QA Checklist.
...
### 5. Motion Review
Read `references/motion-designer.md` — use the Motion QA Checklist.
